...
var DraftEditorBlock = /*#__PURE__*/function (_React$Component) {
  ...
  function DraftEditorBlock() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleRenderChildren", function (leafSet, ii, text, blockKey, block, lastLeafSet, hasSelection, snippets) {
      return new Promise(function (resolve) {
        ...
        var result = /*#__PURE__*/React.createElement(DecoratorComponent, _extends({}, decoratorProps, commonProps), leaves);
  ...
  _proto._renderChildren = function _renderChildren() {
    ...
    return this.props.tree.map(function (leafSet, ii) {
      ...
      return /*#__PURE__*/React.createElement(DecoratorComponent, _extends({}, decoratorProps, commonProps), leaves);
    }).toArray();
  };
